...
- [ ] T004 Tighten skills/homelab-stack-triage/SKILL.md and add conditional handoffs in skills/network-exposure-verification/SKILL.md and skills/triage-dependency-updates/SKILL.md.

## Verification and completion

- [x] T005 Evaluate specs/002-homelab-skill-gaps/quickstart.md scenarios and record checks and privacy results there.
- [ ] T006 Review diffs, update CHANGELOG.md, and commit task-owned changes.
