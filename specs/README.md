...
| [005 Retrospective baseline](005-retrospective-baseline/spec.md) | Collection coverage and completion assessment at `8e51a4f` |

The retrospective baseline contains contracts for
[maintenance](005-retrospective-baseline/contracts/maintenance.md),
[engineering](005-retrospective-baseline/contracts/engineering.md),
[web and visuals](005-retrospective-baseline/contracts/web-visual.md), and
[system operations](005-retrospective-baseline/contracts/systems.md).
Use its [coverage map](005-retrospective-baseline/coverage.md) to locate each
registered skill and its [assessment](005-retrospective-baseline/assessment.md)
