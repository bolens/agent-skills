...
Original project: [https://github.com/JuliusBrussee/caveman](https://github.com/JuliusBrussee/caveman)

Tracked branch: `main`

Original path: `skills/caveman-compress`
...
- Use an owned temporary directory for candidate validation; preserve neighboring staging files and clean scratch candidates on every exit. Document the independent Claude backend and data-transfer requirement across agent hosts, including standard compatibility metadata.
