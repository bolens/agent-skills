...
Original project: [https://github.com/basecamp/omarchy](https://github.com/basecamp/omarchy)

Tracked branch: `quattro`

Original path: `default/agents/skills/omarchy`
...
- Scope desktop triggers to identified Omarchy-owned configuration, preserve other distributions and source-development exclusion, and carry existing reset authorization forward.
